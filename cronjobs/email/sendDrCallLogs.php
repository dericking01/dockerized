...
//	$filename='/root/cronjobs/email/storage/CDR_DAILY_'.date("Y_m_d", strtotime("-$z days")).'.csv';
	...
	$filename='/root/cronjobs/email/storage/DR_CALLS_'.date("Y-m-d", strtotime("-$z days")).'.csv';
//$filename='/root/cronjobs/email/storage/DR_CALLS_'.date("2024-02-17").'.csv';
...
//    $mail->addAddress('derrick@afyacall.co.tz');
  ...
  // $mail->addCC('cc@example.com');
   // $mail->addBCC('bcc@example.com');
    ...
    $mail->Subject = 'Afyacall DR CALLS '.$day;
    $mail->Body    = 'This is the automated email for Dr calls';
